...
from __future__ import (absolute_import, division, print_function,
                        unicode_literals)
import jieba
jieba.load_userdict("textrank4zh/user.txt")
...
def get_default_stop_words_file():
    ...
    #return os.path.join(d, '/Users/leon/Downloads/TextRank4ZH-master/textrank4zh/stopwords.txt')

class WordSegmentation(object):
    """ 分词 """
    
    def __init__(self, stop_words_file = True, allow_speech_tags = util.allow_speech_tags):
        """
        Keyword arguments:
    ...
    def segment(self, text, lower = True, use_stop_words = True, use_speech_tags_filter = False):
        ...
        self.default_speech_tag_filter.append('x')
